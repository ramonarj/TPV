...
void ExampleGame::initGame() {
	...
	bonusManager_ = new BonusManager(this);
	collisionManager_ = new CollisionManager(this, bulletsManager_, asteroidsManager_, fightersManager_, bonusManager_);
	...
	collisionManager_->registerObserver(bonusManager_);
	...
	bulletsManager_->registerObserver(bulletsManager_);
	bulletsManager_->registerObserver(asteroidsManager_);*/
	bonusManager_->registerObserver(gameManager_);
	...
	gameManager_->registerObserver(bonusManager_);
...
void ExampleGame::closeGame() {
	if (bonusManager_ != nullptr)
		delete bonusManager_;
