...
GameMap::GameMap()
: GameObject(nullptr), muro(nullptr), comida(nullptr), vitamina(nullptr), foodLeft(0), vitaminFrame(0){}

GameMap::GameMap(Texture* muro, Texture* comida, Texture* vitamina, Game* juego)
	: GameObject(juego), muro(muro), comida(comida), vitamina(vitamina), foodLeft(0), vitaminFrame(0) {}
...
{
	//Vacío
	if (valor == 0) cells[i][j] = Empty;
	//Muro
	else if (valor == 1) cells[i][j] = Wall;
	//Comida
	else if (valor == 2)
	{
		cells[i][j] = Food;
...
{
	//Vacío
	if (valor == Empty) file << 0;
	//Muro
	else if (valor == Wall) file << 1;
	//Comida
	else if (valor == Food) file << 2;
	//Vitamina
	else if (valor == Vitamins) file << 3;
	else cout << valor;
