...
public:
	...
	Ghost();
	//Constructora
	Ghost(Texture* texture, Game* juego, PlayState* playState, unsigned int ghostNo);
	Ghost(Texture* texture, Game* juego, PlayState* playState, unsigned int ghostNo, unsigned int posX, unsigned int posY);
	//Métodos heredados
	virtual void update();
