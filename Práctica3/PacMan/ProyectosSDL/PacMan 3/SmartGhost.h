...
public:
	SmartGhost();
	SmartGhost(Texture* texture, Game* juego, PlayState* playState);
	SmartGhost(Texture* texture, Game* juego, PlayState* playState, unsigned int posX, unsigned int posY); //Para las relaciones entre SmartGhosts
